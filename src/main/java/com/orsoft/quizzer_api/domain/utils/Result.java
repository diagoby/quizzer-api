...
//  }
//
//  public static <U> Result<U> ofOptional(Optional<U> value, String error) {
//    return value.map(Result::ok).orElse(Result.error(error));
//  }
//
...
//  }
//
//  public <X extends Throwable> T getOrThrow(Function<String, ? extends X> action) throws X {
//    return value.orElseThrow(() -> action.apply(error.get()));
//  }
//
//  public void ifResult(Consumer<? super T> action) {
//    if(isResult()) {
//      action.accept(getValue());
//    }
//  }
//
//  public void ifError(Consumer<String> action) {
//    if(isError()) {
//      action.accept(getError());
//    }
//  }
